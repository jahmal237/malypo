...
public class SignatureActivity extends AppCompatActivity {
    ...
    String country, ph, pass, fn, ln, em;
    ...
    Button.OnClickListener onButtonClick = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v == mClear) {
                ...
                Toast.makeText(getApplicationContext(), "Panel Cleared", Toast.LENGTH_SHORT).show();
                mSignature.clear();
                mGetSign.setEnabled(false);
            } else if (v == mGetSign) {
                Log.v("log_tag", "Panel Saved");
                if (!isStoragePermissionGranted()) {
                    Toast.makeText(getApplicationContext(), "Sorry you dont have permission to save this file", Toast.LENGTH_SHORT).show();
                    recreate();
                } else {
                ...
                Toast.makeText(getApplicationContext(), "Panel canceled", Toast.LENGTH_SHORT).show();
                // Calling the BillDetailsActivity
                Intent intent = new Intent(SignatureActivity.this, RegisterDisplay.class);
    ...
    public class signature extends View {
        ...
        public void save(View v, String StoredPath) {
            ...
            try {
                ...
                intent.putExtra("signature", "Signature - ok");
                intent.putExtra("coun", country);
